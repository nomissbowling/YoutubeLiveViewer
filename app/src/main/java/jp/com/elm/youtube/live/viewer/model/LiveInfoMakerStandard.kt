...
class LiveInfoMakerStandard() : OperationLiveInfoMaker {
    ...
    override fun makeViewModels(response: String): List<LiveInfoViewModel> {
        val liveInfo : JSONArray = createLivesJson(response)
        val infoList = mutableListOf<LiveInfoViewModel>()
    ...
    override fun makeViewModel(liveInfo: JSONObject): LiveInfoViewModel
        = LiveInfoViewModelStandard(
